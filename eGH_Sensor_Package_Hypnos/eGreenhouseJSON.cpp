...
void json_to_struct(const JsonObjectConst& data, SitkaNet_t& out) {
    ...
    // TSL2591 Vis
    get_data_point_from_contents(contents, "TSL2591", "Vis", out.data.tsl2591Vis);

    // TSL2591 IR
    get_data_point_from_contents(contents, "TSL2591", "IR", out.data.tsl2591IR);

    // TSL2591 Full
    get_data_point_from_contents(contents, "TSL2591", "Full", out.data.tsl2591Full);
